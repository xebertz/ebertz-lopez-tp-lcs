...
Como el objetivo del trabajo es crear un modelo de IA con fines médicos, decidimos cambiar el proyecto.

Nuestro nuevo objetivo es detectar si un lunar es benigno o maligno a partir de una imagen. Debido a que seguimos utilizando imagenes, podemos reutilizar todo el trabajo ya desarrollado, cambiando la fuente de datos.
