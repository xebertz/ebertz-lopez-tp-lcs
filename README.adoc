...
A lo largo de esta fase del proyecto, nos encontramos con diversas dificultades, entre las que se incluyen:
    ...
    * Que los resultados tengan sentido en el modelo de la IA: Una vez entrenado el modelo se trato de verificar su precisión pero este en ves de dar resultados de 0 o 1 para determinar la enfermedad ocular presente daba un valor superior a 1
...
== Conclusión
    ...
    Tras el analisis de la actividad en general, podemos aclarar con sertesa la utilidad de las inteligencias artificiales en diferentes aplicaciones, como en el caso nuestro, sobre actividades medicas. lamentablemente se encontraron problemas a varios pasos del procesos, que terminaron en la generacion de un modelo funcional pero que su presicion no supera el 47% en sus predicciones.

    Estos resultados indicca que si bien las IA tienen potencal de contribuir en el campo medico, existen varios obstaculos que se deben superar para poder tener mejor efectividad y confiabilidad.

    Estas dificultades se puede encontrar tanto en la calidad de los datos obtenidos, como en la arquitectura del modelo utilizado.  
     
    Por ende en futuras entregas se buscaran mejores maneras de entrenar a la red neuronal profunda para generar mejores resultados.