...
El _Machine Learning_ o _Aprendizaje Automático_ es una forma de entrenar a las inteligencias artificiales (IA). Es una disciplina dentro del campo más amplio de la inteligencia artificial que se centra en el desarrollo de algoritmos y modelos que permiten a las máquinas aprender a partir de datos y mejorar su rendimiento en tareas específicas con la experiencia.
